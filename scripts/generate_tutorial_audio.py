...
TUTORIAL_TEXTS = [
    ...
    "If I turn someone into a dark shadow, it means I want you to tell me who they are, or give them a name!",
    ...
    "And if something is missing, a puzzle piece will show where it should be!",
...
def main():
    ...
    import sys
    # Optional args: step numbers to regenerate (e.g. "4 9 17"); default = all
