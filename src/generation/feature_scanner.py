"""DEPRECATED — Visual feature scanning module via Gemini 3.1 Pro.

This module is deprecated and kept for reference only.
It has been replaced by the new architecture where features are part of
the detailed scene manifest generated by the Scene Manifest + NEG Module.
