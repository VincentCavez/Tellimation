...
(function() {
  ...
  var TUTORIAL_STEPS = [
    ...
    { text: "If you see the day turn into night, it means time is passing — tell me what happens later!", audio: "/oral-instructions/tutorial_12.wav", animFn: function() { return { template: 'timelapse', params: { isIndoor: false } }; } },
